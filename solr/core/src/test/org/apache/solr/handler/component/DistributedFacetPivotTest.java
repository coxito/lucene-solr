...
public class DistributedFacetPivotTest extends BaseDistributedSearchTestCase {
  ...
  private void setupDistributedPivotFacetDocuments() throws Exception{
    ...
    for(Integer i=0;i<maxDocs;i++){//50 entries
      ...
      zeroShard.add(new Object[]{"id", String.valueOf(getDocNum()), "place_s", "dublin", "company_t", "microsoft polecat bbc","pay_i",2400,"hiredate_dt", "2012-07-01T12:30:00Z"});
    ...
    oneShard.add(new Object[]{"id", String.valueOf(getDocNum()), "place_s", "dublin", "company_t", "microsoft ","pay_i",6539,"hiredate_dt", "2012-11-01T12:30:00Z"});
